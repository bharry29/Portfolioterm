    ...
    >
      <div className="max-w-4xl mx-auto">
        ...
        >
          ...
          <div className="space-y-4 text-green-300 text-sm font-mono leading-relaxed">
            <p>
            ...
            <div className="border-l-2 border-green-500/50 pl-4 my-4">
              <h3 className="text-green-400 font-bold mb-2">$ leadership_philosophy</h3>
            ...
            <div className="border-l-2 border-green-500/50 pl-4 my-4">
              <h3 className="text-green-400 font-bold mb-2">$ achievements</h3>
