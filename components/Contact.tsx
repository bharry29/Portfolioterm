...
export default function Contact() {
  ...
  return (
    <section id="contact" ref={ref} className="py-4 sm:py-6 md:py-8 px-3 sm:px-4">
        ...
        >
          ...
          <div className="space-y-3 sm:space-y-4">
            {contactInfo.map((info, index) => (
              ...
              >
                <span className="text-green-500 w-full sm:w-20 text-xs sm:text-sm shrink-0">$ {info.label.toLowerCase()}</span>
                <a
                  href={info.href}
                  target={info.href.startsWith('http') ? '_blank' : undefined}
                  rel={info.href.startsWith('http') ? 'noopener noreferrer' : undefined}
                  className="text-green-300 hover:text-green-400 text-xs sm:text-sm break-all sm:break-normal"
                >
                  {info.value}
                </a>
              </motion.div>
          ...
          <div className="mt-4 sm:mt-6 pt-4 border-t border-green-500/30">
            <h3 className="text-green-400 font-bold mb-3 text-xs sm:text-sm">$ send_message</h3>
            <form onSubmit={handleSubmit} className="space-y-3">
              <div>
                ...
                <input
                  ...
                  className="w-full px-3 py-2 bg-black border border-green-500/30 text-green-300 text-xs sm:text-sm focus:outline-none focus:border-green-500"
              ...
              <div>
                ...
                <textarea
                  ...
                  rows={4}
                  className="w-full px-3 py-2 bg-black border border-green-500/30 text-green-300 text-xs sm:text-sm focus:outline-none focus:border-green-500 resize-none"
              ...
              <button
                type="submit"
                className="px-4 py-2 border border-green-500 text-green-400 hover:bg-green-500/10 text-xs sm:text-sm transition-colors"
              >
                $ submit
              </button>
            </form>
