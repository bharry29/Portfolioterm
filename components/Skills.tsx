...
export default function Skills() {
  ...
  return (
    <section id="skills" ref={ref} className="py-8 px-4">
        ...
        >
          ...
          <div className="space-y-2">
            {filteredSkills.map((skill, index) => (
              ...
              >
                <span className="text-green-300 text-sm w-32">{skill.name}</span>
                <div className="flex-1 bg-green-900/20 border border-green-500/20 h-4">
                  <motion.div
                    initial={{ width: 0 }}
                ...
                <span className="text-green-400 text-xs w-12 text-right">{skill.level}%</span>
              </motion.div>
            ))}
          </div>
